...
const Work = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-cyan-400">
      <h1 className="ml-20 text-xl md:text-2xl font-medium py-4 mb-8 underline underline-offset-8">
        Company Projects
      </h1>
      <div className="mx-auto flex flex-wrap gap-10 ml-20">
        <Cards
          image={atcat}
          desc={atcatDesc}
          title={"ATCAT"}
      ...
      <h2 className="mt-20 ml-20 text-xl md:text-2xl font-medium py-4 mb-8 underline underline-offset-8">
        Personal Projects
      </h2>
      <div className="mx-auto flex flex-wrap gap-10 ml-20 pb-20">
        <Cards
          image={portfolio}
          desc={portfolioDesc}
